        ...
        <div class="container mt-3">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Tambah qris</h4>
                            <form class="forms-sample" action="{{ route('qris.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <a type="submit" href="{{route('qris.index')}}" class="btn btn-light">Batal</a>
