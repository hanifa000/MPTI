                ...
                <div class="col-md-8 offset-md-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('album.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <a type="submit" href="{{route('album.index')}}" class="btn btn-light">Batal</a>
