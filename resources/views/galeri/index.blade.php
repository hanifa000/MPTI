                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="btn btn-primary btn-sm" href="{{route('album.create')}}" type="submit">Tambah
                                    Foto</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="square-image-container">
                                                        <img src="{{ asset('foto_album/' . $gambar->foto) }}"
                                                            alt="foto_gambar" class="square-image">
                                                    </div>
                                                </td>
